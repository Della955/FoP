import unittest
from lemonadestand import MenuItem, LemonadeStand, InvalidSalesItem
...
class TestLemonadeStand(unittest.TestCase):
  ...
  def test_total_profit_for_poptart(self):
    ...
    stand.enter_sales_history(day_0)
    stand.enter_sales_history(day_1)
    total_profit = stand.total_profit_for_menu_items('poptart')
...
#     'cake': 10
#     }
#     with self.assertRaises(InvalidSalesError):
#       stand.enter_sales_history(day_0)
